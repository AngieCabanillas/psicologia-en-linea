...
export const ForosPag = () => {
    ...
    return (
        <Spin spinning={loading} className="h-100" indicator={circleIcon}>
            <div className="flotante fixed h-16 w-16 z-50 bg-black bottom-6 right-6 rounded-full flex items-center justify-center bottom-6 right-6" onClick={openModalForo}>
